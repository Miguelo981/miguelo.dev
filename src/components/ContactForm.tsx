...
import { createForm } from "../services/contanct-form/contact-form.service";
...
export default function ContactForm() {
    ...
    return (
        <form className="space-y-6 w-full mt-8 text-start" onSubmit={formik.handleSubmit} method="post">
            <Toaster />
            <div className="relative">
                ...
                <input
                    ...
                    name="full_name"
                    className={
                        "app-text-input " + (formik.errors.full_name ? "" : "is-valid")
                    }
            ...
            <div className="relative">
                ...
                <input
                    ...
                    name="email"
                    className={
                        "app-text-input " + (formik.values.email == ""
                            ? ""
                            : formik.errors.email
                                ? "invalid"
                                : "is-valid")
            ...
            <button className='view-more text-white w-full text-2xl lg:text-2xl' type="submit" disabled={((!(formik.isValid && formik.dirty)) || formik.isSubmitting)}>{t('contact.buttons.submit') as any}</button>
        </form>
    )
};